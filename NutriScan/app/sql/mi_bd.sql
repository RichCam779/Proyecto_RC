...
-- 0. FUNCIÓN DE ACTUALIZACIÓN AUTOMÁTICA
CREATE OR REPLACE FUNCTION actualizar_fecha_modificacion()
RETURNS TRIGGER AS $$
BEGIN
    NEW.actualizar = CURRENT_TIMESTAMP;
    RETURN NEW;
END;
$$ LANGUAGE plpgsql;
...
CREATE TABLE perfiles_clinicos (
    ...
    estado VARCHAR(20) DEFAULT 'Activo', -- Agregado para consistencia
    crear TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    actualizar TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE registro_consumo (
    ...
    estado VARCHAR(20) DEFAULT 'Activo', -- Agregado
    crear TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    actualizar TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE historial_chat (
    ...
    id_historial INT NOT NULL REFERENCES historial(id_historial),
    id_usuario INT NOT NULL REFERENCES usuarios(id_usuario),
...
CREATE TRIGGER trigger_update_chat BEFORE UPDATE ON historial_chat FOR EACH ROW EXECUTE FUNCTION actualizar_fecha_modificacion();
...
('1001', 'Juan Perez', 'juan.admin@app.com', 'Masculino', 'Colombia', 'Bogota', 'Bogota', 'pass1', 1),
('1002', 'Dra. Maria Lopez', 'maria.nutri@app.com', 'Femenino', 'Colombia', 'Antioquia', 'Medellin', 'pass2', 2),
('1003', 'Carlos Cliente', 'carlos.c@gmail.com', 'Masculino', 'Mexico', 'CDMX', 'CDMX', 'pass3', 3),
('1004', 'Ana Paciente', 'ana.p@gmail.com', 'Femenino', 'Argentina', 'BA', 'Buenos Aires', 'pass4', 3),
('1005', 'Pedro Fitness', 'pedro.fit@gym.com', 'Masculino', 'Chile', 'Santiago', 'Santiago', 'pass5', 4),
('1006', 'Laura Soporte', 'laura.help@app.com', 'Femenino', 'Peru', 'Lima', 'Lima', 'pass6', 5),
('1007', 'Sofia Garcia', 'sofia.g@yahoo.com', 'Femenino', 'Espana', 'Madrid', 'Madrid', 'pass7', 3),
('1008', 'Miguel Torres', 'miguel.t@hotmail.com', 'Masculino', 'Colombia', 'Valle', 'Cali', 'pass8', 3),
('1009', 'Lucia Mendez', 'lucia.m@outlook.com', 'Femenino', 'Colombia', 'Atlantico', 'Barranquilla', 'pass9', 3),
('1010', 'David Developer', 'david.dev@app.com', 'Masculino', 'Uruguay', 'Montevideo', 'Montevideo', 'pass10', 8);

-- 3.4 TELEFONOS
INSERT INTO telefono (id_usuario, numero, tipo) VALUES
(1, '3001110001', 'Movil'), (2, '3001110002', 'Consultorio'), (3, '3001110003', 'Movil'),
(4, '3001110004', 'Casa'), (5, '3001110005', 'Trabajo'), (6, '3001110006', 'Movil'),
(7, '3001110007', 'Movil'), (8, '3001110008', 'Movil'), (9, '3001110009', 'Casa'), (10, '3001110010', 'Oficina');
...
(1, 1, TRUE, TRUE), (1, 2, TRUE, TRUE), (1, 6, TRUE, TRUE),
(2, 3, TRUE, TRUE), (2, 9, TRUE, TRUE),
(3, 1, TRUE, FALSE), (3, 8, TRUE, TRUE), (3, 4, TRUE, FALSE),
(4, 9, TRUE, FALSE), (5, 5, TRUE, TRUE);
...
-- 3.10 HISTORIAL CHAT
INSERT INTO historial_chat (id_historial, id_usuario, pregunta_usuario, respuesta_ia) VALUES
(1, 3, '¿Cuántas calorías tiene el pollo?', 'El pollo tiene aprox 165 cal por 100g.'),
(1, 3, 'Quiero bajar de peso', 'Debes mantener un déficit calórico.'),
(2, 4, '¿Puedo comer pan si soy celiaca?', 'No, el pan común tiene gluten.'),
(2, 4, 'Receta de desayuno', 'Prueba avena con manzana.'),
(3, 7, '¿Qué es mejor cardio o pesas?', 'Una combinación de ambos es ideal.'),
(4, 8, '¿El aguacate engorda?', 'Es grasa saludable, pero consúmelo con moderación.'),
(5, 9, 'Tengo ansiedad por dulce', 'Prueba comer fruta o chocolate negro.'),
(1, 3, 'Rutina para pecho', 'Press de banca y flexiones.'),
(2, 4, '¿Cuánta agua debo tomar?', 'Aproximadamente 2 litros al día.'),
(6, 10, '¿La creatina es segura?', 'Sí, es uno de los suplementos más estudiados.');
